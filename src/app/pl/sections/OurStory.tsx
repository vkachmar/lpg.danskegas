...
const STATS_DATA: StatItem[] = [
    {
        ...
        value: 100000,
        suffix: "+",
        label: "ton paliw i produktów energetycznych importowanych rocznie",
    },
    {
        id: "2",
        value: 30,
        suffix: "+",
        label: "sektorów obsługiwanych w Europie Środkowej i Północnej",
    },
    {
        id: "3",
        value: 99.9,
        suffix: "%",
        label: "dostaw na czas we wszystkich kanałach logistycznych",
    },
    {
        id: "4",
        value: 15,
        suffix: "",
        label: "lat doświadczenia w imporcie i logistyce paliw",
    },
];
                ...
                <div className="w-full max-w-[544px] mx-auto space-y-2 md:space-y-[15px] lg:space-y-[23px] xl:space-y-[28px] shrink-0">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-[34px] xl:text-[40px] leading-[133%] xl:font-medium text-center">
                            Danske Gas – Dostarczamy paliwa, które napędzają świat
                        </h1>
                    </div>

                    <p className="text-black text-[16px] md:text-[20px] leading-[140%] md:leading-[150%] tracking-[-0.2] text-center md:px-4">
                        Danske Gas S.A. jest częścią grupy kapitałowej działającej od blisko dwudziestu lat. Jesteśmy niezależnym importerem paliw płynnych i stałych, w tym LPG (butan, propan i mieszanki), estru metylowego, HVO, węgla oraz pelletu, dostarczanych głównie drogą morską i kolejową.
                    </p>
                </div>
