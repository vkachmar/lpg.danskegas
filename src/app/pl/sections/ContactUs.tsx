    ...
    >
      ...
      >
        {isDesktop ? (
          <>
            Pozostaw dane, a my
            <br />
            się z Tobą skontaktujemy
          </>
        ) : isTablet ? (
          <>Pozostaw dane, a my się z Tobą skontaktujemy</>
        ) : isMobile ? (
          <>
            Pozostaw dane
            <br />
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={formClass}>
        ...
        <FormField
          ...
          options={[
            "Dział LPG",
            "Dział Oleju Grzewczego",
            "Dział Paliw Tradycyjnych (Olej Napędowy i Benzyna)",
            "Dział Paliw Wyścigowych",
            "Dział Paliw Stałych",
            "Dział Energii Elektrycznej",
            "Dział Gazów Technicznych",
            "Dział Chemikaliów",
            "Dział Olejów i Smarów Lotniczych",
            "Dział Paliw BIO",
          ]}
        />
        ...
        >
          ...
          >
            <span className="relative z-10">Wyślij zgłoszenie</span>
...
const HeaderSection: React.FC<HeaderSectionProps> = ({ careerPage }) => (
  <div className="text-white mb-12">
    ...
    >
      {careerPage ? (
        <>
          Masz pytania dotyczące paliw, logistyki lub innych spraw? Nasz zespół chętnie udzieli odpowiedzi, doradzi i zaproponuje rozwiązania dopasowane do Twojego biznesu.
        </>
      ) : (
        <>
          Masz pytania dotyczące paliw, logistyki lub innych spraw? Nasz zespół chętnie udzieli odpowiedzi, doradzi i zaproponuje rozwiązania dopasowane do Twojego biznesu.
